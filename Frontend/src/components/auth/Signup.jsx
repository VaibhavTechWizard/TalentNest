...
//             <Input type="text" value={input.fullname} name="fullname" onChange={changeEventHandler} placeholder="vam" />
//           </div>
...
//             <Input type="number" value={input.phoneNumber} name="phoneNumber" onChange={changeEventHandler} placeholder="1234" />
//           </div>
...
//           <Button type="submit" className="w-full my-4 bg-gray-800 text-white">Signup</Button>
